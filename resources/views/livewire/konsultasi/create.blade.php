<div class="p-6 md:py-16">
  <div class="max-w-3xl mx-auto py-16 px-10 bg-white shadow-lg rounded-lg ">
    ...
    @else
      ...
      @if ($currentStep === 1)
        <div>
          <h2 class="text-2xl font-semibold mb-6 text-blue-600">Pilih Lokasi & Dokter</h2>
          <div class="mb-6">
      ...
      @elseif ($currentStep === 2)
        {{-- Step 2: Pembayaran --}}
        <div>
          <h2 class="text-2xl font-semibold mb-6 text-blue-600">Pembayaran</h2>
          <div class="relative mb-10 flex flex-row items-center mt-4 gap-2 ">
            <div class="w-full">
              <label for="default-input" class="block text-sm font-medium text-gray-700">Masukkan Voucher</label>
      ...
      @elseif ($currentStep === 4)
        ...
        <div class="mb-6">
          ...
          <textarea wire:model="consultationDescription"
            class="mt-2 block w-full px-3 py-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200"
