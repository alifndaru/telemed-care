...
@section('content')
    <div class="provider-container container mt-36 h-auto  ">
        <div
            class="provider-list md:flex flex-row p-10 justify-between h-full  ">
            <div class="provider-category w-96">
                ...
                <div class="flex flex-col  p-5 gap-3">
                    <a href="javascript:void(0)" class="category font-semibold text-sky-600 text-md" data-category="1"><i
                            class="fas fa-caret-right  mr-2"></i>Dokter Spesialis</a>
                    ...
                    <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <li class="inline-flex items-center">
                                <a href="#" onclick="location.reload()" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-sky-600">
                                    Provider
                                </a>
                            </li>
